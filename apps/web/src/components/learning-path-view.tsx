      ...
      <div className="learn-layout">
        <ol className="learn-path" aria-label="Company Analysis Basics concepts">
          ...
          <li data-state={cashFlowState} aria-current={cashFlowState === "current" ? "step" : undefined}>
            <span className="learn-path__marker" aria-hidden="true" />
            <article>
              <header><h2>Operating Cash Flow</h2><LearningState state={cashFlowState} /></header>
              <p>See how Apple&apos;s Net Income connects to cash generated by operating activities.</p>
              <Link href="/company/aapl/operating-cash-flow">
                {actionLabel(cashFlowState)} lesson
                <span aria-hidden="true">→</span>
              </Link>
            </article>
          </li>
          ...
          <li data-state="coming-later">
            ...
            <article>
              ...
              <p>The next company-analysis concept is still being validated.</p>
            </article>
          </li>
        </ol>
