...
test("all eleven concepts have canonical Learn pages with learning identity", async () => {
...
test("previous and next lesson ordering follows the approved eleven-concept sequence", () => {
